...
export const fallbackCvData: CvData = {
  ...
  experiences: [
    ...
    },
    {
      ...
      descriptions: [
        'Menyelesaikan tantangan rekayasa perangkat lunak (software engineering quests), meliputi perbaikan bug repositori nyata, penanganan kebocoran memori (memory leaks), dan optimasi performa algoritma.',
        'Menulis kode solusi deterministik dan test suites berbasis Python/TypeScript yang lolos validasi otomatis ketat (score validation, memory profiling, dan peer code review).',
        'Menyediakan data penalaran kode (code reasoning) dan penanganan edge cases berstandar industri guna melatih kemampuan debugging dan generasi kode pada frontier LLMs.',
      ],
    },
  ],
  education: [
...
export const fallbackCvDataEn: CvData = {
  ...
  experiences: [
    ...
    },
    {
      ...
      descriptions: [
        'Solve complex software engineering quests, including real-world repository bug fixing, memory leak resolution, and algorithmic performance optimizations.',
        'Author clean, deterministic code solutions and comprehensive test suites in Python and TypeScript that pass strict automated verification (score validation, memory profiling, and peer code reviews).',
        'Produce high-quality code reasoning and edge-case benchmarks to advance frontier LLM capabilities in automated code generation and debugging.',
      ],
    },
  ],
  education: [
